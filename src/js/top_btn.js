...
document.getElementById('toTop').setAttribute("style", "display: none; position: fixed;font-family: 'Roboto Mono', monospace;bottom: 18px; right: 18px; z-index: 1000; border: none; outline: none; background: #FF7B59;border-radius: 5px; padding: 10px; color:white; cursor: pointer");
